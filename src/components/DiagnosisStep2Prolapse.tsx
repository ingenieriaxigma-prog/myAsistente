...
import { prolapseSymptoms } from '../config/symptoms';

interface DiagnosisStep2ProlapseProps {
  specialty: Specialty;
  onBack: () => void;
  onContinue: (prolapseSymptoms: string[]) => void;
  initialSymptoms: string[];
}

export function DiagnosisStep2Prolapse({ specialty, onBack, onContinue, initialSymptoms }: DiagnosisStep2ProlapseProps) {
  ...
  return (
    <DiagnosisScreenLayout
      ...
      subtitle="Síntomas de prolapso"
      stepInfo="Paso 4 de 8"
      onBack={onBack}
      footer={
        <GradientButton
          gradient={theme.gradient}
      ...
      <div className="p-6 pb-8">
        <div className={`${theme.lightBg} rounded-2xl p-4 mb-6`}>
          <p className="text-sm text-gray-700">
            Selecciona los síntomas relacionados con prolapso o soporte pélvico que hayas experimentado.
          </p>
        </div>

        <SymptomSelector
          symptoms={prolapseSymptoms}
