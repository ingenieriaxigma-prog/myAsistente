...
import { maleSymptoms } from '../config/symptoms';

interface DiagnosisStep2MaleProps {
  specialty: Specialty;
  onBack: () => void;
  onContinue: (maleSymptoms: string[]) => void;
  initialSymptoms: string[];
}

export function DiagnosisStep2Male({ specialty, onBack, onContinue, initialSymptoms }: DiagnosisStep2MaleProps) {
  ...
  return (
    <DiagnosisScreenLayout
      ...
      subtitle="Síntomas de salud masculina"
      stepInfo="Paso 6 de 8"
      onBack={onBack}
      footer={
        <GradientButton
          gradient={theme.gradient}
      ...
      <div className="p-6 pb-8">
        <div className={`${theme.lightBg} rounded-2xl p-4 mb-6`}>
          <p className="text-sm text-gray-700">
            Selecciona los síntomas relacionados con salud masculina que hayas experimentado.
          </p>
        </div>

        <SymptomSelector
          symptoms={maleSymptoms}
